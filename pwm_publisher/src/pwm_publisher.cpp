...
void read_pkt(void)
{
    ...
    while (1) {
        ...
        //good packet
        if (25 == ptr){
            if (0x1f == sbusData[0] && 0x00 == sbusData[24]) { break; } 
            else { ++count_bad; } //printf("%d, %d\n",sbusData[0],sbusData[24]);
        }
    }
...
int main(int argc, char **argv)
{
    ...
    while(1){ read_pkt(); };
//左控制器：前后ch3 1065-1510-1933,左右ch4 1066-1500-1933;  
//右控制器：左右ch1 1067-1500-1932
//开关A：ch9 down 1933 up 1065 
//开关B：ch8 down 1873 up 1065 
    return 0;
}